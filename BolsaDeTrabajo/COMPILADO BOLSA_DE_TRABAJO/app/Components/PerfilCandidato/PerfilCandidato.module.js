...
PerfilCandidatoModule = __decorate([
    core_1.NgModule({
        imports: [platform_browser_1.BrowserModule, forms_1.ReactiveFormsModule, forms_1.FormsModule, http_1.HttpModule,
            ...
            PerfilCandidato_routing_1.PerfilCandidatoRoutingModule, Shared_module_1.SharedModule],
        declarations: [
        ...
        providers: [{ provide: common_1.APP_BASE_HREF, useValue: '/' }, catalogos_service_1.CatalogosService, Catalogo_PerfilCandidato_service_1.CatalogoPerfilCandidatoService]
    })
