...
var ConocimientoComponent = (function () {
    ...
    ConocimientoComponent.prototype.EntityAttached = function (idInstitucion) {
        var institucion = this.filteredInstituciones.find(function (x) { return x.id == idInstitucion; });
        this.Conocimientos.get('institucionEducativa').setValue(institucion);
    };
    ...
    ConocimientoComponent.prototype.Save = function () {
        ...
        if (this.Conocimientos.get('id').value == '0') {
            this._perfilCandidatoService.AddConocimiento(this.Conocimientos.value)
                ...
                _this.EntityAttached(conocimiento.institucionEducativaId);
            });
        }
        else {
