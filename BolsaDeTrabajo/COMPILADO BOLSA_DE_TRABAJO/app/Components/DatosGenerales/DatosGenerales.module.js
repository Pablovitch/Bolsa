...
DatosGeneralesModule = __decorate([
    core_1.NgModule({
        imports: [platform_browser_1.BrowserModule, forms_1.ReactiveFormsModule, forms_1.FormsModule, http_1.HttpModule,
            ...
            DatosGenerales_routing_1.DatosGeneralesRoutingModule, Shared_module_1.SharedModule, PerfilCandidato_module_1.PerfilCandidatoModule
        ],
        declarations: [
        ...
        providers: [{ provide: common_1.APP_BASE_HREF, useValue: '/' }, DatosGenerales_service_1.DatosGeneralesService, Direccion_Service_1.DireccionService, catalogos_service_1.CatalogosService, CURP_validator_1.CURPValidator, ProfileImage_service_1.PerfilImageService]
    })
