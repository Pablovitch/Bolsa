...
FormulariosInicialesModule = __decorate([
    core_1.NgModule({
        imports: [platform_browser_1.BrowserModule, forms_1.ReactiveFormsModule, forms_1.FormsModule, http_1.HttpModule, formularios_routing_1.FormulariosRoutingModule,
            primeng_1.CalendarModule, primeng_1.AutoCompleteModule, animations_1.BrowserAnimationsModule, primeng_1.CheckboxModule, DatosGenerales_module_1.DatosGeneralesModule, Shared_module_1.SharedModule],
        declarations: [
            DatosDireccion_component_1.DatosDireccionComponent,
            DatosPerfil_component_1.DatosPerfilComponent,
        ],
        providers: [{ provide: common_1.APP_BASE_HREF, useValue: '/' }, DatosDeCandidato_Service_1.DatosCandidatoService, Direccion_Service_1.DireccionService, DatosPerfil_service_1.DatosPerfilService, catalogos_service_1.CatalogosService, CURP_validator_1.CURPValidator,
            PerfilCandidato_Service_1.PerfilCandidatoService, Catalogo_PerfilCandidato_service_1.CatalogoPerfilCandidatoService,
