...
AppModule = __decorate([
    core_1.NgModule({
        imports: [platform_browser_1.BrowserModule, forms_2.ReactiveFormsModule, forms_1.FormsModule, http_1.HttpModule, app_routing_1.routing, animations_1.BrowserAnimationsModule,
            primeng_1.CalendarModule, primeng_1.AutoCompleteModule, primeng_1.CheckboxModule,
            FormulariosIniciales_module_1.FormulariosInicialesModule, Shared_module_1.SharedModule,
        ],
        declarations: [
            app_component_1.AppComponent, DatosDeContacto_component_1.DatosDeContactoComponent
        ],
        providers: [{ provide: common_1.APP_BASE_HREF, useValue: '/' }, Candidatos_Service_1.CandidatosService, primeng_1.CalendarModule, primeng_1.AutoCompleteModule, primeng_1.CheckboxModule],
