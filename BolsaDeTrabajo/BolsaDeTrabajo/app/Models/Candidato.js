...
var Identificaciones = (function () {
    function Identificaciones() {
    }
    return Identificaciones;
}());
exports.Identificaciones = Identificaciones;
...
var InformacionGeneral = (function () {
    function InformacionGeneral() {
    }
    return InformacionGeneral;
}());
exports.InformacionGeneral = InformacionGeneral;
var RedSocial = (function () {
    function RedSocial() {
    }
    return RedSocial;
}());
exports.RedSocial = RedSocial;
var TipoRedSocial = (function () {
    function TipoRedSocial() {
    }
    return TipoRedSocial;
}());
exports.TipoRedSocial = TipoRedSocial;
