...
var DatosPersonalesComponent = (function () {
    function DatosPersonalesComponent(_DatosGeneralesService, fb, _Router, _Route, _catalogosService) {
        ...
        this.formDatosPersonales = fb.group({
            ...
            codigoPostal: [''],
            generoId: [{ value: '', disabled: true }, forms_1.Validators.compose([
            ...
            whatsApp: [false],
            telLocal: [false],
            fechaNacimiento: [{ value: '', disabled: true }, forms_1.Validators.required],
        });
    }
    ...
    DatosPersonalesComponent.prototype.GetInitilaData = function () {
        var _this = this;
        this._DatosGeneralesService.GetDatosPersonales(this.CandidatoId)
            ...
            _this.EstadoNacimiento = (PersonalData.estadoNacimiento == null) ? '' : PersonalData.estadoNacimiento.estado;
            ...
            _this.esMexicano = (PersonalData.paisNacimiento.pais.toLowerCase() == 'mexico') ? true : false;
            if (!_this.esMexicano) {
                _this.formDatosPersonales.get('municipioNacimiento').disable();
            }
