...
var DatosGeneralesService = (function () {
    function DatosGeneralesService(_http) {
        ...
        this._urlRedesSociales = "/api/RedesSociales";
    }
    /**
   Información General
    */
    ...
    */
     ...
     * Redes Sociales
     */
    DatosGeneralesService.prototype.GetRedesSociales = function (CandidatoId) {
    ...
    DatosGeneralesService.prototype.AddRedesSociales = function (redesSociales, candidatoId) {
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var options = new http_1.RequestOptions({ headers: headers });
